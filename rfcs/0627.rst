...
-  People who have contributed to the php-src git repository, and; More
   ...
   group of 175 developers, and as of Feb 5 2019, this group grew to 180
   developers. See Appendix A below.
-  Members of PHP-FIG (as per https://www.php-fig.org/personnel/)
...
who have voted in at least 3 php.net polls between January 1, 2018 and
December 31, 2018, and do not otherwise qualify as Eligible Voters under
this RFC - will temporarily be considered Eligible Voters. This
temporary status will remain in effect for 1 year after the acceptance
of this RFC. Such grandfathered voters can retain Eligible Voters status
by qualifying into one of the above-mentioned groups during that time.
...
`Git Statistics for the PHP project, Feb
2019 <https://wiki.php.net/gitstats_02_19>`__ - relevant stats are
...
:Slug: voting2019
:Wiki URL: https://wiki.php.net/rfc/voting2019
