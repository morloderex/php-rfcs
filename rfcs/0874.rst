...
currently supported by PDO in core, the proposal is to:
...
#. Add a MySQL specific scanner function:
   ...
   #. two-dashes, C-style comments, and Hash-comments, albeit I couldn't
      force the requirement of a space after "--" (I tried, but failed)
   #. Tests, as necessary
...
trying to modifying the common parser code.
...
Support for escape string literal is out of scope of this RFC and should
be documented as incompatible in the UPGRADING file, as weirdly enough
it previously was the only fully-compatible format.
