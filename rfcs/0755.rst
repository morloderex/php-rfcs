Named Parameters Explicit Opt In
================================
...
depreciation warning will be raised, and the parameter will be opted in
automatically. It should be assumed by developers that the depreciation
