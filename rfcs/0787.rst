...
dedicated, more self-descriptive functionality. We believe it would be
prudent to revisit that behavior in the future, and consider removing
cases 2 and 3 above entirely. That is left for a future deprecation RFC,
however, and this RFC makes no changes in that direction.
