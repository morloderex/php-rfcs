...
can be well-optimized by the compiler and/or runtime. (The specific
details are not relevant at the moment.) That is, the "logical property"
(that code would see) and the "physical property" (the actual storage)
are already separate from the start.
