...
-  Any int
-  Any float
-  Any static string (not with string interpolation), denoted with
   single quotes, double quotes, heredoc or nowdoc.
...
properties. The use case is arguably smaller, but it would be reasonable
to allow variable binding in this case.
